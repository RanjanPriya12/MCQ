...
const cookieService = require("../services/cookies.manager");
...
router.post("/login", async (request, response) => {
  try {
    ...
    let user = await userService.getUserByEmail(email);
    if (!user) {
      return response.status(401).json({ errors: [{ msg: "Invalid Email, please enter your valid email" }] });
    }
...
//         errors: [
//           {
//             msg: "Only aadmin has right to get all the data of user",
//           },
//         ],
//       });
//     }
...
//         errors: [
//           {
//             msg: "Only admin has right to delete the users",
//           },
//         ],
//       });
//     }
